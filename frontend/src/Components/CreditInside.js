      ...
      <div className='cc-left'>
        ...
        <select
          ...
          >
           ...
           <option value='Creating a Culture of Change'>Creating a Culture of Change</option>
           <option value='Cross Culture Intelligence'>Cross Culture Intelligence</option>
           <option value='Conversation at Work'>Conversation at Work</option>
           <option value='Discovering Your Strength'>Discovering Your Strength</option>
           <option value='Developing a Learning Mindset'>Developing a Learning Mindset</option>
           <option value='Interpersonal Communication'>Interpersonal Communication</option>
           <option value='Learning with Emotional Intelligence'>Learning with Emotional Intelligence</option>
           <option value='Managing Adverse Team'>Managing Adverse Team</option>
          </select> 
          ...
          >
            ...
            <option value='Leadership Strategies for Women'>Leadership Strategies for Women</option>
            <option value='Skills for Inclusive Conversations'>Skills for Inclusive Conversations</option>
          ...
          >
            ...
            <option value='Preparing for Successfull...'>Preparing for Successfull...</option>
            <option value='Writing White Papers'>Writing White Papers</option>
          ...
          >
            ...
            <option value='Leading in Government'>Leading in Government</option>
          </select>
          ...
          <select id='menu' value={'Team Skills'} onChange={handleOptionChange}>
            ...
            <option value='Teamwork Foundations'>Teamwork Foundations</option>
          </select>
        </div>
      </div>
