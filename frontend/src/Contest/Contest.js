  ...
  return (
    <div className='help-cont'>
      ...
      <div className='contest-wrap'>
        {filtered.length > 0 ? filtered.map(contest => {
          return <HelpCards key={uuidV4()} contest={contest} />
        }): (
          <div style={{alignItems:'center', marginLeft:'36%' , width:'100vw'}}>
